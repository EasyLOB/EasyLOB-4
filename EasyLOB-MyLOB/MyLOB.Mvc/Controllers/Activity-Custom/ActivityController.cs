    ...
    public partial class ActivityController : BaseMvcControllerSCRUDApplication<EasyLOB.Activity.Data.Activity>
    {
        ...
        public ActionResult DataSource(DataManager dataManager)
        {
            ...
            if (IsSearch(operationResult))
            {
                ...
                /// Error
                //operationResult.AddOperationError("", "Error 1");
                //operationResult.AddOperationError("", "Error 2");
                //operationResult.AddOperationWarning("", "Warning");
                //operationResult.AddOperationInformation("", "Information");

                //// Exception
                //operationResult.ParseException(new Exception("Exception 1"));
                //operationResult.ParseException(new Exception("Exception 2"));
