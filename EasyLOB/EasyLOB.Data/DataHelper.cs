...
namespace EasyLOB.Data
{
    ...
    public static partial class DataHelper
    {
        ...
        /// Get resource.
        /// </summary>
        /// <param name="typeDataModel"></param>
        /// <param name="resource"></param>
        /// <returns></returns>
        public static string GetResource(Type typeDataModel, string resource)
        {
            string result = "";

            try
            {
                string typeFullName = GetResourcesTypeFullName(typeDataModel);
                Type type = LibraryHelper.GetType(typeFullName);
                if (type != null)
                {
                    result = (string)LibraryHelper.GetStaticPropertyValue(type, resource);
                }
            }
            catch { }
        ...
        /// <param name="typeDataModel"></param>
        /// <returns></returns>
        public static string GetResourcesTypeFullName(Type typeDataModel)
        {
            return typeDataModel.FullName.Replace(".Data.", ".Data.Resources.") + "Resources";
        }
        ...
        /// <summary>
        /// Setup Data Profiles for assembly.
        /// </summary>
        /// <param name="dataAssemblyName">Data assembly</param>
        public static void SetupDataProfiles(string dataAssemblyName)
        {
            ...
            {
                if (typeDataModel.IsSubclassOf(typeof(ZDataModel)) && !typeDataModel.IsAbstract)
                {
        ...
        public static IZProfile SetDataProfile(Type typeDataModel)
        {
            ...
            if (!Profiles.Keys.Contains(typeDataModel))
            {
                ...
                profile.TypeFullName = typeDataModel.FullName;
            ...
            foreach (PropertyInfo property in properties)
            {
                ...
                {
                    // Associations - ZDataModel
                    bool isAssociation = false;
                    if (property.PropertyType.IsSubclassOf(typeof(ZDataModel)) && !property.PropertyType.IsAbstract)
                    {
                        isAssociation = true;
                        profile.Associations.Add(property.Name);
                    }

                    // Collections - IList<ZDataModel>
                    bool isCollection = false;
                    Type typeIList = IListType(property.PropertyType);
                    if (typeIList.IsSubclassOf(typeof(ZDataModel)) && !typeIList.IsAbstract)
                    {
                        isCollection = true;
        ...
        /// <summary>
        /// Setup View Profiles for assembly.
        /// </summary>
        /// <param name="dataAssemblyName">Data assembly</param>
        /// <param name="viewAssemblyName">View assembly</param>
        public static void SetupViewProfiles(string dataAssemblyName, string viewAssemblyName)
        {
            Assembly.Load(dataAssemblyName);
        ...
        public static IZProfile SetViewProfile(Type typeViewModel, Type typeDataModel)
        {
            ...
            foreach (PropertyInfo property in properties)
            {
                if (property.Name != "LookupText")
                {
                    ...
                    if (Attribute.IsDefined(property, typeof(RequiredAttribute)))
                    {
                        profileProperty.IsAttributeRequired = true;
                    }
                    else
                    {
                        profileProperty.IsAttributeRequired = false;
                    }
                    ...
                    profileProperty.IsEditRequired = false;
