...
namespace EasyLOB.Persistence
{
    ...
    public static class DbDataReaderExtensions
    {
        ...
        {
            return reader.IsDBNull(index) ? default(bool) : reader.GetBoolean(index);
        }
        ...
        {
            return reader.IsDBNull(index) ? default(byte) : reader.GetByte(index);
        }
        ...
        {
            return reader.IsDBNull(index) ? default(DateTime) : reader.GetDateTime(index);
        }
        ...
        {
            return reader.IsDBNull(index) ? (short)default(short) : reader.GetInt16(index);
        }
        ...
        {
            return reader.IsDBNull(index) ? default(int) : reader.GetInt32(index);
        }
        ...
        {
            return reader.IsDBNull(index) ? default(long) : reader.GetInt64(index);
        }
        ...
        {
            return reader.IsDBNull(index) ? default(float) : reader.GetFloat(index);
        }
